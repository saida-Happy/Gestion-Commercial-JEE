...
public class ClientDAO extends HibernateDaoSupport {
	...
	public static final String TELE_CLIENT = "teleClient";
	...
	public Client findById(java.lang.Integer id) {
		...
		try {
			Client instance = (Client) getHibernateTemplate().get("dao.Client",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByNomClient(Object nomClient) {
		return findByProperty(NOM_CLIENT, nomClient);
	}

	public List findByAdresseClient(Object adresseClient) {
		return findByProperty(ADRESSE_CLIENT, adresseClient);
	}

	public List findByTeleClient(Object teleClient) {
		return findByProperty(TELE_CLIENT, teleClient);
	}

	public List findByEmailClient(Object emailClient) {
		return findByProperty(EMAIL_CLIENT, emailClient);
	}
