				...
				<div class="row animated zoomIn">
					...
					<h:form rendered="true">
						...
						<h:commandButton styleClass="btn btn-theme02"
							...
							action="#{Client.ajouterClient}" value="Ajouter client">
							<f:param name="nomClient" value="#{Client.nomClient}"></f:param>
							<f:param name="adresseClient" value="#{Client.adresseClient}"></f:param>
						...
						<h:commandButton styleClass="btn btn-theme02"
							...
							action="#{Client.annulerClient}" value="Annuler" immediate="true"></h:commandButton>
